...
def book(request):
    ...
    if rbooking_s.is_valid():
        ...
        if auth is not False:
            ...
            return JsonResponse({'response':"auth failed"}, safe=False)
    else:
        return JsonResponse({'response':"request failed, missing"}, safe=False)
