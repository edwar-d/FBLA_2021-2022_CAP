...
export default class Checkout extends React.Component 
{
  ...
  async post_r() {
    const api_url = "http://127.0.0.1:8000/api/v1.1.2/json/p/book";
    const cd = require("../assets/json/cache.json");
  ...
  {this.renderRedirect()}
  <div className="container2 preload">
  ...
  <div className="form-container">
    ...
    <div className="field-container">
      ...
      <span id="generatecard">Card Type</span>
    ...
    <div className="actualcontainer">
      ...
      <div className="container">
        <div className="formtitle">Personal Info</div>
